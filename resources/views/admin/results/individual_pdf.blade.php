    ...
    <div class="container">
        <div class="certificate">
            <div class="header">
                ...
                <p>LAPORAN EVALUASI RESMI</p>
            </div>

            <div class="content">
                <p class="given-to">Diberikan kepada:</p>
                <div class="user-name">{{ strtoupper($result->user->name) }}</div>

                <p class="given-to">Telah menyelesaikan evaluasi pada kuis:</p>
                ...
                <div class="stats">
                    ...
                    <div class="stat-item">
                        <div class="stat-value">{{ $result->correct_answers }}</div>
                ...
                <div class="passed-status {{ $result->is_passed ? 'status-success' : 'status-danger' }}">
            ...
            <div class="footer">
                <div class="date">
                    Tanggal: {{ $result->created_at->isoFormat('D MMMM YYYY') }}<br>
                    ID: {{ $result->id . time() }}
                </div>
                <div class="signature">
                    <div style="height: 60px;"></div>
                    <div class="signature-line"></div>
                    <strong>Admin Evaluasi</strong><br>
                    {{ config('app.name') }}
                </div>
            </div>
        </div>
