<x-app-layout title="Edit Kuis">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="{{ route('admin.quizzes.show', $quiz) }}"
                                    class="text-sm font-medium text-secondary-500 hover:text-brand-600 transition-colors">Detail</a>
                            </div>
                        </li>
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm font-medium text-secondary-900">Edit Kuis</span>
                            </div>
                        </li>
                    </ol>
                </nav>
    ...
    <div class="max-w-4xl mx-auto">
        <form action="{{ route('admin.quizzes.update', $quiz) }}" method="POST" class="space-y-8">
            @csrf
            @method('PUT')
            ...
            <div class="bg-white rounded-3xl shadow-card border border-secondary-100/50 overflow-hidden">
                ...
                <div class="p-8 space-y-6">
                    <div>
                        ...
                        <x-text-input id="title" name="title" type="text" class="w-full" :value="old('title', $quiz->title)" required />
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="4"
                            ...
                            placeholder="Tuliskan deskripsi kuis di sini...">{{ old('description', $quiz->description) }}</textarea>
