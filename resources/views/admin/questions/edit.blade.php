<x-app-layout title="Edit Soal">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm font-medium text-secondary-900">Edit Soal</span>
                            </div>
                        </li>
                    </ol>
                </nav>
    ...
    <div class="max-w-4xl mx-auto" x-data="{ 
        ...
        options: @js(old('options', $question->options->pluck('option_text'))),
        corrects: @js(old('correct_options', $question->options->where('is_correct', true)->keys()->map(fn($k) => (string) $k)->toArray())),
        addOption() {
            this.options.push('');
        },
        removeOption(index) {
    ...
    }" x-init="checkType(true)">
        <form action="{{ route('admin.questions.update', [$quiz, $question]) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
                ...
                <div class="p-8 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="score" type="number" name="score"
                                value="{{ old('score', $question->score) }}" min="1" required class="w-full" />
