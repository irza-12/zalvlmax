...
<div class="row">
    <div class="col-md-8">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.questions.update', [$quiz, $question]) }}" method="POST" id="questionForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                                ...
                                <option value="multiple_correct" {{ old('type', $question->type) == 'multiple_correct' ? 'selected' : '' }}>Multiple Correct</option>
                            </select>
                            @error('type')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <div id="optionsContainer">
                            ...
                            {{-- If fewer than 2 options (due to validation error in prev submit or data issue), add placeholder --}}
        ...
        <div class="card">
            ...
            <div class="card-body">
                <ul class="small text-muted mb-0">
                    <li>Pastikan minimal ada 2 opsi jawaban.</li>
                    <li>Jangan lupa menandai jawaban yang benar.</li>
                    <li>Total persentase kuis dihitung dari jumlah bobot nilai semua soal.</li>
                </ul>
            </div>
        </div>
    </div>
...
@push('scripts')
<script>
let optionIndex = {{ $question->options->count() > 2 ? $question->options->count() : 2 }};
...
function updateOptionIndexes() {
    ...
    options.forEach((option, index) => {
        ...
        // Don't change placeholder to A, B, C if it's true/false or custom text desired, but helps consistency
