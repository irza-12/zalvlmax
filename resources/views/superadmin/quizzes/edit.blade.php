                                ...
                                <div class="flex rounded-xl shadow-sm">
                                    <div class="relative flex flex-grow items-stretch focus-within:z-10">
                                        ...
                                        <input type="text" name="access_password" id="accessCode"
                                            ...
                                            placeholder="Contoh: 123456" required pattern="[0-9]{6}" inputmode="numeric"
                                            maxlength="6"
                                            class="block w-full rounded-none rounded-l-xl border-0 py-3 pl-10 px-4 text-brand-700 font-bold font-mono tracking-wider ring-1 ring-inset ring-secondary-200 placeholder:text-secondary-400 focus:ring-2 focus:ring-inset focus:ring-brand-600 sm:text-sm sm:leading-6 bg-white">
                                    </div>
