...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card bg-primary text-white mb-4">
        <div class="card-body py-4">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h3 class="mb-2">Selamat Datang, <?php echo e(auth()->user()->name); ?>!</h3>
                ...
                <div class="col-md-4 text-md-end mt-3 mt-md-0">
                    <span class="badge bg-light text-primary p-2">
                        <i class="bi bi-calendar-event me-1"></i> <?php echo e(now()->format('d M Y')); ?>
    ...
    <div class="card border-0 shadow-sm mb-4" style="background: linear-gradient(45deg, #6366f1 0%, #a855f7 100%);">
        <div class="card-body p-4 p-md-5 text-center text-white">
            ...
            <form action="<?php echo e(route('user.quizzes.join')); ?>" method="POST" class="row justify-content-center">
                <?php echo csrf_field(); ?>
        ...
        <div class="col-md-3 col-6 mb-3">
            <div class="card h-100">
                <div class="card-body text-center py-4">
                    ...
                    <h3 class="mb-1"><?php echo e($totalQuizzesTaken); ?></h3>
        ...
        <div class="col-md-3 col-6 mb-3">
            <div class="card h-100">
                <div class="card-body text-center py-4">
                    ...
                    <h3 class="mb-1"><?php echo e(round($averageScore, 1)); ?></h3>
        ...
        <div class="col-md-3 col-6 mb-3">
            <div class="card h-100">
                <div class="card-body text-center py-4">
                    ...
                    <h3 class="mb-1"><?php echo e($totalCorrectAnswers); ?></h3>
        ...
        <div class="col-md-3 col-6 mb-3">
            <div class="card h-100">
                <div class="card-body text-center py-4">
                    ...
                    <h3 class="mb-1"><?php echo e($totalWrongAnswers); ?></h3>
        ...
        <div class="col-lg-8 mb-4">
            <div class="card h-100">
                <div class="card-header bg-white d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo e(route('user.results.index')); ?>" class="btn btn-sm btn-outline-primary">Lihat Semua</a>
                </div>
                <div class="card-body p-0">
                            ...
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $recentResults; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>
                                                <div class="fw-medium"><?php echo e(Str::limit($result->quiz->title ?? 'Unknown', 30)); ?></div>
                                            </td>
                                            <td>
                                                <span class="fw-bold"><?php echo e($result->total_score); ?></span>
                                                <span class="text-muted small">/ <?php echo e($result->max_score ?? 100); ?></span>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <small class="text-muted"><?php echo e($result->created_at->diffForHumans()); ?></small>
                                            </td>
                                        </tr>
                    ...
                    <?php else: ?>
                        <div class="text-center py-5">
                            ...
                            <a href="<?php echo e(route('user.quizzes.index')); ?>" class="btn btn-primary">
            ...
            <div class="card h-100">
                ...
                <div class="card-body">
                    <div class="d-grid gap-3">
                        <a href="<?php echo e(route('user.results.index')); ?>" class="btn btn-outline-success text-start py-3">
                            <i class="bi bi-file-earmark-bar-graph me-2"></i>Lihat Riwayat
                        </a>
                        <a href="<?php echo e(route('user.leaderboard')); ?>" class="btn btn-outline-warning text-start py-3">
                            <i class="bi bi-trophy me-2"></i>Leaderboard
                        </a>
                        <a href="<?php echo e(route('profile.edit')); ?>" class="btn btn-outline-secondary text-start py-3">
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Hype AMD\.gemini\antigravity\scratch\coc-quiz-app\resources\views/user/dashboard.blade.php ENDPATH**/ ?>