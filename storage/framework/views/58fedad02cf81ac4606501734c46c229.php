    ...
    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4 mb-8">
        ...
        <div class="rounded-lg bg-white p-5 shadow-card border border-secondary-100 flex items-center">
            ...
            <div class="ml-4">
                ...
                <dd class="mt-1 text-2xl font-semibold tracking-tight text-secondary-900">
                    <?php echo e(number_format($summary['total_attempts'] ?? 0)); ?></dd>
            </div>
        </div>
        ...
        <div class="rounded-lg bg-white p-5 shadow-card border border-secondary-100 flex items-center">
            ...
            <div class="ml-4">
                ...
                <dd class="mt-1 text-2xl font-semibold tracking-tight text-secondary-900">
                    <?php echo e($summary['pass_rate'] ?? 0); ?>%</dd>
            </div>
        </div>
        ...
        <div class="rounded-lg bg-white p-5 shadow-card border border-secondary-100 flex items-center">
            ...
            <div class="ml-4">
                ...
                <dd class="mt-1 text-2xl font-semibold tracking-tight text-secondary-900">
                    <?php echo e($summary['avg_score'] ?? 0); ?>%</dd>
            </div>
        </div>
        ...
        <div class="rounded-lg bg-white p-5 shadow-card border border-secondary-100 flex items-center">
            ...
            <div class="ml-4">
                ...
                <dd class="mt-1 text-2xl font-semibold tracking-tight text-secondary-900">
                    <?php echo e($summary['highest_score'] ?? 0); ?>%</dd>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-secondary-200">
                    ...
                    <tbody class="divide-y divide-secondary-200 bg-white">
                        <?php $__empty_1 = true; $__currentLoopData = $quizStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quiz): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-secondary-50 transition-colors">
                                <td class="px-6 py-4 text-sm font-medium text-secondary-900"><?php echo e($quiz->title ?? 'Unknown'); ?>

                                </td>
                                <td class="px-6 py-4 text-center">
                                    <span
                                        class="inline-flex items-center rounded-md bg-secondary-100 px-2.5 py-0.5 text-xs font-medium text-secondary-800"><?php echo e($quiz->total_attempts ?? 0); ?></span>
                                </td>
                                <td class="px-6 py-4 text-center">
                                    <span
                                        class="inline-flex items-center rounded-md bg-green-50 px-2.5 py-0.5 text-xs font-medium text-green-700 ring-1 ring-inset ring-green-600/20"><?php echo e($quiz->passed ?? 0); ?></span>
                                </td>
                                <td class="px-6 py-4 text-center text-sm text-secondary-600">
                                    <?php echo e(round($quiz->avg_score ?? 0, 1)); ?>%</td>
                                <td class="px-6 py-4">
                                    <?php $passRate = ($quiz->total_attempts ?? 0) > 0 ? round(($quiz->passed ?? 0) / ($quiz->total_attempts ?? 1) * 100) : 0; ?>
                                    <div class="flex items-center gap-3">
                                        <div class="flex-grow rounded-full bg-secondary-100 h-2">
                                            <div class="h-2 rounded-full <?php echo e($passRate >= 70 ? 'bg-green-500' : 'bg-red-500'); ?>"
                                                style="width: <?php echo e($passRate); ?>%"></div>
                                        </div>
                                        <span
                                            class="text-xs font-medium text-secondary-500 w-8 text-right"><?php echo e($passRate); ?>%</span>
                                    </div>
                                </td>
                            </tr>
        ...
        <div class="rounded-lg bg-white shadow-card border border-secondary-100 overflow-hidden">
            ...
            <ul role="list" class="divide-y divide-secondary-100">
                <?php $__empty_1 = true; $__currentLoopData = $topPerformers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <li class="flex items-center justify-between gap-x-6 px-6 py-4 hover:bg-secondary-50 transition-colors">
                        <div class="flex min-w-0 gap-x-4">
                            <span
                                class="flex items-center justify-center w-6 font-bold <?php echo e($index < 3 ? 'text-amber-500' : 'text-secondary-400'); ?>">#<?php echo e($index + 1); ?></span>
                            <div class="min-w-0 flex-auto">
                                <p class="text-sm font-semibold leading-6 text-secondary-900">
                                    <?php echo e($result->user->name ?? 'Unknown'); ?></p>
                                <p class="mt-1 truncate text-xs leading-5 text-secondary-500">
                                    <?php echo e(Str::limit($result->quiz->title ?? '', 25)); ?></p>
                            </div>
                        </div>
                        <div class="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
                            <span
                                class="inline-flex items-center rounded-md bg-green-50 px-2 py-1 text-xs font-medium text-green-700 ring-1 ring-inset ring-green-600/20"><?php echo e(round($result->percentage)); ?>%</span>
                        </div>
                    </li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php endif; ?><?php /**PATH C:\Users\Hype AMD\.gemini\antigravity\scratch\coc-quiz-app\resources\views/superadmin/statistics/index.blade.php ENDPATH**/ ?>