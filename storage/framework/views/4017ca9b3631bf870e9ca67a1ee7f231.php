            ...
            <form action="" method="GET" class="flex flex-col sm:flex-row gap-4">
                ...
                <div class="sm:w-40">
                    <select name="role"
                        ...
                        <option value="super_admin" <?php echo e(request('role') == 'super_admin' ? 'selected' : ''); ?>>Super Admin
                        </option>
                            ...
                            <tr class="hover:bg-secondary-50/50 transition-colors">
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            <div class="text-sm font-medium text-secondary-900"><?php echo e($user->name); ?></div>
                                            <div class="text-sm text-secondary-500"><?php echo e($user->email); ?></div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end gap-x-2">
                                        ...
                                        <?php if($user->id !== auth()->id()): ?>
                                            <form action="<?php echo e(route('superadmin.users.toggle-status', $user)); ?>" method="POST"
                                                class="inline">
                                                <?php echo csrf_field(); ?>
                                                <button type="submit"
                                            ...
                                            <form action="<?php echo e(route('superadmin.users.reset-password', $user)); ?>" method="POST"
...
<?php endif; ?><?php /**PATH C:\Users\Hype AMD\.gemini\antigravity\scratch\coc-quiz-app\resources\views/superadmin/users/index.blade.php ENDPATH**/ ?>