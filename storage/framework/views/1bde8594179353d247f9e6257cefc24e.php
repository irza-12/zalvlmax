...
<head>
    ...
    <title><?php echo e(config('app.name', 'ZalvlmaX')); ?> - <?php echo $__env->yieldContent('title'); ?></title>
    <!-- Bootstrap 5 CSS -->
...
<body>
    ...
    <nav class="navbar navbar-expand-lg sticky-top">
        <div class="container">
            <a class="navbar-brand" href="<?php echo e(route('user.dashboard')); ?>">
                <i class="bi bi-ui-checks-grid text-primary me-2"></i><?php echo e(config('app.name')); ?>
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-center">
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('user.dashboard') ? 'active' : ''); ?>"
                            href="<?php echo e(route('user.dashboard')); ?>">Dashboard</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('user.quizzes.*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('user.quizzes.index')); ?>">Daftar Kuis</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('user.results.*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('user.results.index')); ?>">Riwayat</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('user.leaderboard') ? 'active' : ''); ?>"
                            href="<?php echo e(route('user.leaderboard')); ?>">Leaderboard</a>
                    </li>
    ...
    <footer>
        <div class="container text-center">
            <p class="text-muted mb-0 small">&copy; <?php echo e(date('Y')); ?> Tim Tata Usaha Kayu. All rights reserved.</p>
        </div>
    </footer>
...
</html><?php /**PATH C:\Users\Hype AMD\.gemini\antigravity\scratch\coc-quiz-app\resources\views/layouts/user.blade.php ENDPATH**/ ?>