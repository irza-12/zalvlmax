        ...
        <div
            ...
            <div class="px-8 py-10 text-center border-b border-secondary-100/50">
                <a href="/" class="inline-flex items-center gap-2 group">
                    <span
                        class="font-display font-bold text-3xl tracking-tight text-secondary-900"><?php echo e(config('app.name')); ?></span>
                </a>
            </div>
...
</html><?php /**PATH C:\Users\Hype AMD\.gemini\antigravity\scratch\coc-quiz-app\resources\views/layouts/guest.blade.php ENDPATH**/ ?>