...
<?php $component->withAttributes([]); ?>
            ...
            <div>
                ...
                <div class="flex items-center gap-2 mt-1">
                    <span
                        ...
                        <?php echo e($quiz->id); ?></span>
                    <p class="text-sm text-secondary-500 truncate max-w-md" title="<?php echo e($quiz->title); ?>">
    ...
    <div x-data="{ 
        ...
        <form action="<?php echo e(route('superadmin.quizzes.update', $quiz)); ?>" method="POST">
                        ...
                        <div class="p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <textarea name="description" rows="4"
                                    class="block w-full rounded-xl border-0 py-3 px-4 text-secondary-900 shadow-sm ring-1 ring-inset ring-secondary-200 placeholder:text-secondary-400 focus:ring-2 focus:ring-inset focus:ring-brand-600 sm:text-sm sm:leading-6 transition-shadow"><?php echo e(old('description', $quiz->description)); ?></textarea>
                            </div>
                            ...
                            <div class="grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-2">
                                <div>
                                    ...
                                    <select name="category_id"
                                        ...
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($category->id); ?>" <?php echo e(old('category_id', $quiz->category_id) == $category->id ? 'selected' : ''); ?>>
                                ...
                                <div>
                                    <label class="block text-sm font-semibold leading-6 text-secondary-900 mb-2">Durasi
                                        (menit)</label>
                                    <input type="number" name="duration" value="<?php echo e(old('duration', $quiz->duration)); ?>"
                                        min="1" required
                                        class="block w-full rounded-xl border-0 py-3 px-4 text-secondary-900 shadow-sm ring-1 ring-inset ring-secondary-200 placeholder:text-secondary-400 focus:ring-2 focus:ring-inset focus:ring-brand-600 sm:text-sm sm:leading-6 transition-shadow">
                                </div>
                            </div>
                                ...
                                <div class="flex rounded-xl shadow-sm">
                                    <div class="relative flex flex-grow items-stretch focus-within:z-10">
                                        ...
                                        <input type="text" name="access_password" id="accessCode"
                                            value="<?php echo e(old('access_password', $quiz->access_password)); ?>"
                    ...
                    <div class="rounded-2xl bg-white shadow-sm ring-1 ring-secondary-900/5 overflow-hidden">
                        <div
                            ...
                            <h3 class="text-base font-bold leading-6 text-secondary-900 flex items-center gap-2">
                                ...
                                Daftar Soal
                                <span
                                    class="inline-flex items-center rounded-full bg-secondary-100 px-2.5 py-0.5 text-xs font-medium text-secondary-800"><?php echo e($quiz->questions->count()); ?></span>
                            </h3>
                                    ...
                                    <div class="flex items-start justify-between gap-4">
                                        <div class="min-w-0 flex-1">
                                            <div class="flex items-center gap-3 mb-3">
                                                ...
                                                <span
                                                    class="inline-flex items-center rounded-md bg-purple-50 px-2 py-1 text-xs font-medium text-purple-700 ring-1 ring-inset ring-purple-700/10"><?php echo e($question->type); ?></span>
                                                <span
                                                    class="inline-flex items-center rounded-md bg-amber-50 px-2 py-1 text-xs font-medium text-amber-700 ring-1 ring-inset ring-amber-600/20"><?php echo e($question->score); ?>

                                                    poin</span>
                                            </div>
                                            <p class="text-sm font-medium text-secondary-900 leading-relaxed">
                                                <?php echo e(Str::limit($question->question_text, 150)); ?>
                                        ...
                                        <div
                                            ...
                                            <button type="button" @click='openEditModal(<?php echo json_encode($question, 15, 512) ?>)'
                                            ...
                                            <button type="button"
                                                @click="if(confirm('Hapus soal ini?')) { document.getElementById('delete-question-<?php echo e($question->id); ?>').submit(); }"
                        ...
                        <div class="p-6 space-y-6">
                            <div>
                                ...
                                <select name="status" required
                                    class="block w-full rounded-xl border-0 py-3 pl-3 pr-10 px-4 text-secondary-900 shadow-sm ring-1 ring-inset ring-secondary-200 focus:ring-2 focus:ring-inset focus:ring-brand-600 sm:text-sm sm:leading-6 transition-shadow">
                                    <option value="draft" <?php echo e(old('status', $quiz->status) == 'draft' ? 'selected' : ''); ?>>
                                        Draft</option>
                                    <option value="active" <?php echo e(old('status', $quiz->status) == 'active' ? 'selected' : ''); ?>>Aktif</option>
                                    <option value="inactive" <?php echo e(old('status', $quiz->status) == 'inactive' ? 'selected' : ''); ?>>Nonaktif</option>
                                    <option value="archived" <?php echo e(old('status', $quiz->status) == 'archived' ? 'selected' : ''); ?>>Diarsipkan</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="max_attempts"
                                    value="<?php echo e(old('max_attempts', $quiz->max_attempts)); ?>" min="1" required
                            ...
                            <div class="border-t border-secondary-100 pt-6 space-y-4">
                                <div class="relative flex items-start group">
                                    <div class="flex h-6 items-center">
                                        <input id="shuffleQuestions" name="shuffle_questions" type="checkbox" <?php echo e(old('shuffle_questions', $quiz->shuffle_questions) ? 'checked' : ''); ?>
                                ...
                                <div class="relative flex items-start group">
                                    <div class="flex h-6 items-center">
                                        <input id="shuffleOptions" name="shuffle_options" type="checkbox" <?php echo e(old('shuffle_options', $quiz->shuffle_options) ? 'checked' : ''); ?>
                                ...
                                <div class="relative flex items-start group">
                                    <div class="flex h-6 items-center">
                                        <input id="showCorrect" name="show_correct_answer" type="checkbox" <?php echo e(old('show_correct_answer', $quiz->show_correct_answer) ? 'checked' : ''); ?>
        ...
        <?php $__currentLoopData = $quiz->questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <form id="delete-question-<?php echo e($question->id); ?>" action="<?php echo e(route('superadmin.questions.destroy', $question)); ?>"
            ...
            <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
                <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    <div x-show="addQuestionModal" @click.outside="addQuestionModal = false"
                        ...
                        <form action="<?php echo e(route('superadmin.questions.store', $quiz)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                                        ...
                                        <?php $__currentLoopData = range(0, 3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="flex items-center gap-3 mb-3 last:mb-0">
                                                <div
                                                    ...
                                                    <input type="radio" name="correct_option" value="<?php echo e($i); ?>" <?php echo e($i === 0 ? 'required' : ''); ?>

                                                        class="h-5 w-5 border-secondary-300 text-brand-600 focus:ring-brand-600 cursor-pointer">
                                                </div>
                                                <input type="text" name="options[<?php echo e($i); ?>][text]"
                ...
                <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    <div x-show="editQuestionModal" @click.outside="editQuestionModal = false"
                        ...
                        <template x-if="editingQuestion">
                            <form
                                :action="'<?php echo e(route('superadmin.questions.update', 'ID_PLACEHOLDER')); ?>'.replace('ID_PLACEHOLDER', editingQuestion.id)"
                                method="POST">
                                <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                                <input type="hidden" name="type" value="multiple_choice">
                                <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
...
<?php endif; ?><?php /**PATH C:\Users\Hype AMD\.gemini\antigravity\scratch\coc-quiz-app\resources\views/superadmin/quizzes/edit.blade.php ENDPATH**/ ?>