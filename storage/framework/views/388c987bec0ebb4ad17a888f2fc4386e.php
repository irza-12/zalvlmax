                ...
                <select name="quiz_id"
                    ...
                    <?php $__currentLoopData = $quizzes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quiz): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($quiz->id); ?>" <?php echo e(request('quiz_id') == $quiz->id ? 'selected' : ''); ?>>
                            <?php echo e($quiz->title); ?> (<?php echo e($quiz->results_count); ?> peserta)
                        </option>
                    ...
                    <?php if($selectedQuiz): ?>
                        <div class="relative" x-data="{ open: false }">
                            ...
                            <div x-show="open" x-transition:enter="transition ease-out duration-100"
                                ...
                                style="display: none;">
                                <a href="<?php echo e(route('superadmin.reports.export-excel', $selectedQuiz)); ?>"
                                ...
                                <a href="<?php echo e(route('superadmin.reports.export-pdf-all', $selectedQuiz)); ?>" target="_blank"
                                    class="flex px-4 py-2 text-sm text-secondary-700 hover:bg-secondary-50">
                                ...
                                <?php $__currentLoopData = $leaderboard; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-secondary-50 transition-colors">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <?php else: ?>
                                                <span
                                                    class="flex h-8 w-8 items-center justify-center rounded-full bg-secondary-100 text-sm font-bold text-secondary-500">#<?php echo e($item['rank']); ?></span>
                                            <?php endif; ?>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="h-9 w-9 flex-shrink-0">
                                                    <div
                                                        ...
                                                        <?php echo e(strtoupper(substr($item['user']['name'], 0, 2))); ?>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="text-lg font-bold text-secondary-900"><?php echo e($item['score']); ?></span>
                                            <span class="text-xs text-secondary-500">poin</span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span
                                                class="inline-flex items-center rounded-md bg-secondary-100 px-2 py-1 text-xs font-medium text-secondary-600"><?php echo e($item['formatted_completion_time']); ?></span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-right">
                                            ...
                                            ?>
                                            <?php if($printSessionId): ?>
                                                <a href="<?php echo e(route('superadmin.reports.export-pdf', $printSessionId)); ?>"
                    ...
                    <?php else: ?>
                        <div class="flex flex-col items-center justify-center py-12 text-center text-secondary-500">
                            ...
                            <p class="text-base font-semibold text-secondary-900">
                                <?php echo e($selectedQuiz ? 'Belum ada peserta' : 'Pilih kuis untuk melihat leaderboard'); ?>
        ...
        <div class="lg:col-span-5">
            <div class="rounded-lg bg-white shadow-card border border-secondary-100 overflow-hidden">
                ...
                <ul role="list" class="divide-y divide-secondary-100">
                    <?php $__empty_1 = true; $__currentLoopData = $globalLeaderboard; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <li
                            class="flex items-center justify-between gap-x-6 px-6 py-4 hover:bg-secondary-50 transition-colors">
                            <div class="flex min-w-0 gap-x-4">
                                <span
                                    class="flex items-center justify-center w-6 font-bold text-secondary-400">#<?php echo e($index + 1); ?></span>
                                <div class="h-9 w-9 flex-shrink-0">
                                    <div
                                        class="flex h-9 w-9 items-center justify-center rounded-full bg-brand-50 text-xs font-bold text-brand-600 ring-1 ring-brand-100">
                                ...
                                <div class="min-w-0 flex-auto">
                                    <p class="text-sm font-semibold leading-6 text-secondary-900">
                                        <?php echo e($item->user->name ?? 'Unknown'); ?>

                                    </p>
                                    <p class="mt-1 truncate text-xs leading-5 text-secondary-500"><?php echo e($item->quiz_count); ?>

                                        kuis diselesaikan</p>
                                </div>
                            </div>
                            <div class="text-right">
                                <p class="text-sm font-bold text-amber-500"><?php echo e(number_format($item->total_score)); ?></p>
                                <p class="text-xs text-secondary-500"><?php echo e(round($item->avg_percentage)); ?>% avg</p>
                            </div>
                        </li>
...
<?php endif; ?><?php /**PATH C:\Users\Hype AMD\.gemini\antigravity\scratch\coc-quiz-app\resources\views/superadmin/leaderboard/index.blade.php ENDPATH**/ ?>