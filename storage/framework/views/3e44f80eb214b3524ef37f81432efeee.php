            ...
            <tbody class="bg-white divide-y divide-secondary-100">
                <?php $__currentLoopData = $activeSessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $session): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="session-row hover:bg-secondary-50/50 transition-colors"
                        data-start="<?php echo e($session->started_at ? $session->started_at->timestamp : now()->timestamp); ?>"
                        data-answered="<?php echo e($session->progress->where('status', 'answered')->count()); ?>">
                            ...
                            <div class="flex items-center">
                                <div class="h-10 w-10 flex-shrink-0">
                                    <div
                                        ...
                                        <span
                                            class="text-sm font-bold text-brand-700"><?php echo e(strtoupper(substr($session->user->name, 0, 2))); ?></span>
                                    </div>
                                </div>
                                <div class="ml-4">
                                    <div class="text-sm font-medium text-secondary-900"><?php echo e($session->user->name); ?></div>
                                    <div class="text-sm text-secondary-500"><?php echo e($session->user->email); ?></div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4">
                            <span class="text-sm text-secondary-700"><?php echo e($session->quiz->title); ?></span>
                        </td>
                        <td class="px-6 py-4">
                            <?php
                            ...
                            <div class="w-full max-w-xs">
                                <div class="flex items-center justify-between gap-2 mb-1">
                                    <span
                                        class="text-xs font-semibold text-secondary-700 text-right"><?php echo e($answered); ?>/<?php echo e($total); ?></span>
                                </div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <a href="<?php echo e(route('admin.results.export.pdf', ['session_id' => $session->id])); ?>"
...
<?php endif; ?><?php /**PATH C:\Users\Hype AMD\.gemini\antigravity\scratch\coc-quiz-app\resources\views/superadmin/monitor/_session_list.blade.php ENDPATH**/ ?>